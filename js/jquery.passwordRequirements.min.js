    ...
    $.fn.extend({
        passwordRequirements: function(options) {
            ...
            return this.each(function() {
				...
				var numCharactersUI = '<li class="pr-numCharacters"><span></span>Number of characters</li>',
					useLowercaseUI = '',
					useUppercaseUI = '',
					useNumbersUI   = '',
					useSpecialUI   = '';
				...
				var showMessage = function () {
					if (numCharactersDone === false || useLowercaseDone === false || useUppercaseDone === false || useNumbersDone === false || useSpecialDone === false) {
						$(".pr-password").each(function() {
							...
							var posH = $(this).offset().top - 30,
								itemH = $(this).innerHeight(),
								totalH = posH+itemH,
								itemL = $(this).offset().left - 30;
				...
				var checkCompleted = function () {
					if (numCharactersDone === true && useLowercaseDone === true && useUppercaseDone === true && useNumbersDone === true && useSpecialDone === true) {
                        $(".pr-password").removeClass("is-invalid").addClass("is-valid");
					} else {
						showMessage();
                        $(".pr-password").addClass("is-invalid").removeClass("is-valid");
					}
				};
				...
				$(this).on("keyup keydown", function (){
					...
					// special characters meet requirements
					if (o.useSpecial === true) {
